data modify storage spice_in_vanilla:player Item.chest set from block -30000000 1 50232 Items[0]
loot replace entity @s armor.chest mine -30000000 1 50232 minecraft:air{nbt_change:1b}
