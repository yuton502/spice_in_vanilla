...
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/iron_tools={durability_twice_changed_shovel=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/iron_tools={durability_twice_changed_pickaxe=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/iron_tools={durability_twice_changed_axe=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/iron_tools={durability_twice_changed_hoe=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/iron_tools={durability_twice_changed_sword=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
...
#[Truth_Durability * 1f(Durability)] / [MaxDurability(divideScore)] = [DurabilityRatio * 1f(Durability)]
...
execute as @s[nbt={SelectedItem:{tag:{CustomDurability:{Value:0}}}}] store result entity @s SelectedItem.tag.Damage int 1 run scoreboard players get #IronTools Durability
