...
function spice_in_vanilla:items/nether_star_tools/run
function spice_in_vanilla:items/obsidian_tools/run
function spice_in_vanilla:items/prismarine_tools/run
function spice_in_vanilla:items/quartz_tools/run
function spice_in_vanilla:items/redstone_tools/run
...
function spice_in_vanilla:items/using_item/medicine
