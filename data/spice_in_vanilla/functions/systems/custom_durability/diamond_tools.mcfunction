...
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/diamond_tools={durability_twice_changed_shovel=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/diamond_tools={durability_twice_changed_pickaxe=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/diamond_tools={durability_twice_changed_axe=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/diamond_tools={durability_twice_changed_hoe=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
execute as @s[advancements={spice_in_vanilla:systems/custom_durability/diamond_tools={durability_twice_changed_sword=true}}] store result entity @s SelectedItem.tag.CustomDurability.Value int 1 run scoreboard players operation @s Durability -= #1 Durability
