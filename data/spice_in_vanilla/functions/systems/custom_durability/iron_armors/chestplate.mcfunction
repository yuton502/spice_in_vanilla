...
#修繕で回復したダメージ値を反映させる
scoreboard players operation @s Durability = #IronChestplate Durability
...
scoreboard players operation @s DivideScore = #IronChestplate Durability
...
execute as @s[scores={TakenDamage=..0}] store result block -30000000 1 50232 Items[0].tag.Damage int 1 run scoreboard players get #IronChestplate Durability
