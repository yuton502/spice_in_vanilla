...
data modify block -30000000 1 50232 Items append from entity @s SelectedItem
...
execute unless data entity @s Inventory[{Slot:102b}] run data remove storage spice_in_vanilla:player Item.chest
