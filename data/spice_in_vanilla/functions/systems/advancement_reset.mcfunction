advancement revoke @a[advancements={spice_in_vanilla:items/tools/blaze_armor=true}] only spice_in_vanilla:items/tools/blaze_armor
advancement revoke @a[advancements={spice_in_vanilla:items/tools/ender_armor=true}] only spice_in_vanilla:items/tools/ender_armor
