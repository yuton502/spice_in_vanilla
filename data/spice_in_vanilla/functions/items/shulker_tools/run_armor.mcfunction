...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Shulker"}},{Slot:102b,tag:{MaterialType:"Shulker"}},{Slot:101b,tag:{MaterialType:"Shulker"}},{Slot:100b,tag:{MaterialType:"Shulker"}}]}] run schedule function spice_in_vanilla:items/shulker_tools/run_armor 1t
