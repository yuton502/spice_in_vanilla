...
execute as @s store result score @s DivideScore run data get block -30000000 1 50232 Items[0].tag.CustomDurability.Max
...
execute as @s store result score @s DivideScore run data get block -30000000 1 50232 Items[0].tag.CustomDurability.Value
scoreboard players operation @s Durability *= @s DivideScore
