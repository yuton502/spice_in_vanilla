...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Flint"}},{Slot:102b,tag:{MaterialType:"Flint"}},{Slot:101b,tag:{MaterialType:"Flint"}},{Slot:100b,tag:{MaterialType:"Flint"}}]},limit=1] run schedule function spice_in_vanilla:items/flint_tools/run_armor 1t
