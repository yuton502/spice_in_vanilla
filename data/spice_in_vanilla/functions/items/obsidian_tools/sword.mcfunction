...
execute as @e[tag=TakenEntity] at @s run summon arrow ~ ~0.2 ~ {Motion:[0.0f,5.0f,0.0f],damage:8,Tags:["Kill"],Color:-1}
...
execute as @e[tag=TakenEntity] run kill @e[type=arrow,tag=Kill]
