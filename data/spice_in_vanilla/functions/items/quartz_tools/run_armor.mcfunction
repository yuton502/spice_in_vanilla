...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Quartz"}},{Slot:102b,tag:{MaterialType:"Quartz"}},{Slot:101b,tag:{MaterialType:"Quartz"}},{Slot:100b,tag:{MaterialType:"Quartz"}}]}] run schedule function spice_in_vanilla:items/quartz_tools/run_armor 1t
