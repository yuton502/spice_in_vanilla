...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Slime"}},{Slot:102b,tag:{MaterialType:"Slime"}},{Slot:101b,tag:{MaterialType:"Slime"}},{Slot:100b,tag:{MaterialType:"Slime"}}]}] run schedule function spice_in_vanilla:items/slime_tools/run_armor 1t
