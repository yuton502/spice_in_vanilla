...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Melon"}},{Slot:102b,tag:{MaterialType:"Melon"}},{Slot:101b,tag:{MaterialType:"Melon"}},{Slot:100b,tag:{MaterialType:"Melon"}}]}] run schedule function spice_in_vanilla:items/melon_tools/run_armor 1t
