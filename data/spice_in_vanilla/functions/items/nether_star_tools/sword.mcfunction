...
execute as @e[type=arrow,tag=Kill] run data modify entity @s OwnerUUIDLeast set from entity @a[tag=NetherStarSword,limit=1,distance=..6] UUIDLeast
execute as @e[type=arrow,tag=Kill] run data modify entity @s OwnerUUIDMost set from entity @a[tag=NetherStarSword,limit=1,distance=..6] UUIDMost
...
tag @s[tag=NetherStarSword] remove NetherStarSword
