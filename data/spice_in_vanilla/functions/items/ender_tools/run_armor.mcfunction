...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Ender"}},{Slot:102b,tag:{MaterialType:"Ender"}},{Slot:101b,tag:{MaterialType:"Ender"}},{Slot:100b,tag:{MaterialType:"Ender"}}]}] run schedule function spice_in_vanilla:items/ender_tools/run_armor 1t
