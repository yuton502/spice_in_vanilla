...
execute as @a[tag=VarticalHammerNS] at @e[type=item,tag=Hammer] positioned ~1 ~1 ~ if block ~ ~ ~ #spice_in_vanilla:iron_pickaxe_breakable run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
...
execute as @a[tag=VarticalHammerNS] at @e[type=item,tag=Hammer] positioned ~ ~1 ~ if block ~ ~ ~ #spice_in_vanilla:iron_pickaxe_breakable run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
...
execute as @a[tag=VarticalHammerWE] at @e[type=item,tag=Hammer] positioned ~ ~1 ~1 if block ~ ~ ~ #spice_in_vanilla:iron_pickaxe_breakable run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
...
execute as @a[tag=VarticalHammerWE] at @e[type=item,tag=Hammer] positioned ~ ~1 ~ if block ~ ~ ~ #spice_in_vanilla:iron_pickaxe_breakable run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
...
execute as @a[tag=HorizontalHammer] at @e[type=item,tag=Hammer] positioned ~1 ~ ~ if block ~ ~ ~ #spice_in_vanilla:iron_pickaxe_breakable run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
...
execute as @a[tag=HorizontalHammer] at @e[type=item,tag=Hammer] positioned ~1 ~ ~1 if block ~ ~ ~ #spice_in_vanilla:iron_pickaxe_breakable run loot spawn ~ ~ ~ mine ~ ~ ~ mainhand
