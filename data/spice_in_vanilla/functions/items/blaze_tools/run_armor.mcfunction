...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Blaze"}},{Slot:102b,tag:{MaterialType:"Blaze"}},{Slot:101b,tag:{MaterialType:"Blaze"}},{Slot:100b,tag:{MaterialType:"Blaze"}}]},limit=1] run schedule function spice_in_vanilla:items/blaze_tools/run_armor 1t
