...
execute as @a[nbt={Inventory:[{Slot:103b,tag:{MaterialType:"Nether_Star"}},{Slot:102b,tag:{MaterialType:"Nether_Star"}},{Slot:101b,tag:{MaterialType:"Nether_Star"}},{Slot:100b,tag:{MaterialType:"Nether_Star"}}]},limit=1] run schedule function spice_in_vanilla:items/nether_star_tools/run_armor 1t
